...
try { accessSync(file.user) /* check is file */ }
catch (e) { writeFileSync(file.user, JSON.stringify({}, null, 2)) /* Write Default */ }
try { accessSync(file.grup) /* check is file */ }
catch (e) { writeFileSync(file.grup, JSON.stringify({}, null, 2)) /* Write Default */ }
try { accessSync(file.config) /* check is file */ }
catch (e) { writeFileSync(file.config, JSON.stringify({}, null, 2)) /* Write Default */ }
